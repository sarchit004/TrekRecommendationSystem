...
with tabs[1]:
    ...
    if st.button('Get Trek Recommendations', key="recommend_button"):
        ...
        for idx in indices[0]:
            ...
            st.markdown(f"""
            <div class="trek-card">
                <h4>{trek_info['Trek_cleaned']}</h4>
                <p><strong>Cost:</strong> {trek_info['Cost_cleaned']} USD</p>
                <p><strong>Time:</strong> {trek_info['Time_cleaned']} days</p>
                <p><strong>Max Altitude:</strong> {trek_info['Max_Altitude_cleaned']} meters</p>
                <p><strong>Group Size:</strong> {trek_info['trekkig_group_size']}</p>
